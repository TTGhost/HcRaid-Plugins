...
public class LightBlast implements HcEnchantment {
	@Override
	...
	public String getDescription() {
		return "This enchantment will allow you to strike lightning on enemies AOE style!";
	}
	...
	public boolean loadConfig(JavaPlugin jp) {
		jp.getConfig().addDefault("enchants.lightblast.enabled", true);
		return jp.getConfig().getBoolean("enchants.lightblast.enabled");
	}
}
