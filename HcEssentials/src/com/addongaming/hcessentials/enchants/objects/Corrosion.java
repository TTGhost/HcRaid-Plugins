...
public class Corrosion implements HcEnchantment {
	...
	public String getDescription() {
		return "This enchantment will allow you to corrode armour!";
	}
	...
	public boolean loadConfig(JavaPlugin jp) {
		jp.getConfig().addDefault("enchants.corrosion.enabled", true);
		jp.getConfig().addDefault("enchants.corrosion.enchantingRandom", 50);
		jp.getConfig().addDefault("enchants.corrosion.enchantLevel1", 5);
		jp.getConfig().addDefault("enchants.corrosion.enchantLevel2", 17);
		jp.getConfig().addDefault("enchants.corrosion.enchantLevel3", 27);
		jp.getConfig().options().copyDefaults(true);
		jp.saveConfig();
		this.randomNum = jp.getConfig().getInt(
				"enchants.corrosion.enchantingRandom");
		this.enchantLevel1 = jp.getConfig().getInt(
				"enchants.corrosion.enchantLevel1");
		this.enchantLevel2 = jp.getConfig().getInt(
				"enchants.corrosion.enchantLevel2");
		this.enchantLevel3 = jp.getConfig().getInt(
				"enchants.corrosion.enchantLevel3");
		return jp.getConfig().getBoolean("enchants.corrosion.enabled");
	}
