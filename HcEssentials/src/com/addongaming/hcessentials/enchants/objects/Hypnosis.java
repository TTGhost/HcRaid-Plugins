...
public class Hypnosis implements HcEnchantment {
	...
	public String getDescription() {
		return "Make your foes feel unwell with Hypnosis.";
	}
	...
	public boolean loadConfig(JavaPlugin jp) {
		jp.getConfig().addDefault("enchants.hypnosis.enabled", false);
		jp.getConfig().addDefault("enchants.hypnosis.enchantingRandom", 50);
		jp.getConfig().addDefault("enchants.hypnosis.enchantLevel1", 5);
		jp.getConfig().addDefault("enchants.hypnosis.enchantLevel2", 17);
		jp.getConfig().addDefault("enchants.hypnosis.enchantLevel3", 27);
		jp.getConfig().options().copyDefaults(true);
		jp.saveConfig();
		this.randomNum = jp.getConfig().getInt("enchants.hypnosis.enchantingRandom");
		this.enchantLevel1 = jp.getConfig().getInt("enchants.hypnosis.enchantLevel1");
		this.enchantLevel2 = jp.getConfig().getInt("enchants.hypnosis.enchantLevel2");
		this.enchantLevel3 = jp.getConfig().getInt("enchants.hypnosis.enchantLevel3");
		return jp.getConfig().getBoolean("enchants.hypnosis.enabled");
	}
